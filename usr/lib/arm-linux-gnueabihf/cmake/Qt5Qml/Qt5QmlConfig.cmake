...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Qml" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Qml_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Qml_VERSION_STRING 5.11.3)
...
macro(_populate_Qml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Qml_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Qml)
    ...
    set(_Qt5Qml_OWN_INCLUDE_DIRS "${_qt5Qml_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Qml_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQml")
    set(Qt5Qml_PRIVATE_INCLUDE_DIRS
        "${_qt5Qml_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQml/5.11.3"
        "${_qt5Qml_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQml/5.11.3/QtQml"
    )
    ...
    foreach(_module_dep ${_Qt5Qml_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Qml_FIND_VERSION_EXACT}
    ...
    _populate_Qml_target_properties(RELEASE "libQt5Qml.so.5.11.3" "" )
    ...
    macro(_populate_Qml_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Qml_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Qml_check_file_exists(${imported_location})
