...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5MultimediaWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5MultimediaWidgets_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5MultimediaWidgets_VERSION_STRING 5.11.3)
...
macro(_populate_MultimediaWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5MultimediaWidgets_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::MultimediaWidgets)
    ...
    set(_Qt5MultimediaWidgets_OWN_INCLUDE_DIRS "${_qt5MultimediaWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5MultimediaWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimediaWidgets")
    set(Qt5MultimediaWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimediaWidgets/5.11.3"
        "${_qt5MultimediaWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimediaWidgets/5.11.3/QtMultimediaWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5MultimediaWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5MultimediaWidgets_FIND_VERSION_EXACT}
    ...
    _populate_MultimediaWidgets_target_properties(RELEASE "libQt5MultimediaWidgets.so.5.11.3" "" )
    ...
    macro(_populate_MultimediaWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5MultimediaWidgets_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_MultimediaWidgets_check_file_exists(${imported_location})
