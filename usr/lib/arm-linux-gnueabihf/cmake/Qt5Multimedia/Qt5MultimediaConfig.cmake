...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Multimedia" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Multimedia_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Multimedia_VERSION_STRING 5.11.3)
...
macro(_populate_Multimedia_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Multimedia_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(_Qt5Multimedia_OWN_INCLUDE_DIRS "${_qt5Multimedia_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Multimedia_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimedia")
    set(Qt5Multimedia_PRIVATE_INCLUDE_DIRS
        "${_qt5Multimedia_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimedia/5.11.3"
        "${_qt5Multimedia_install_prefix}/include/arm-linux-gnueabihf/qt5/QtMultimedia/5.11.3/QtMultimedia"
    )
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Multimedia_FIND_VERSION_EXACT}
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.11.3" "" )
    ...
    macro(_populate_Multimedia_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Multimedia_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Multimedia_check_file_exists(${imported_location})
