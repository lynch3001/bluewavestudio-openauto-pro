...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5DBus" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5DBus_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5DBus_VERSION_STRING 5.11.3)
...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5DBus_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::DBus)
    ...
    set(_Qt5DBus_OWN_INCLUDE_DIRS "${_qt5DBus_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5DBus_install_prefix}/include/arm-linux-gnueabihf/qt5/QtDBus")
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/arm-linux-gnueabihf/qt5/QtDBus/5.11.3"
        "${_qt5DBus_install_prefix}/include/arm-linux-gnueabihf/qt5/QtDBus/5.11.3/QtDBus"
    )
    ...
    foreach(_module_dep ${_Qt5DBus_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5DBus_FIND_VERSION_EXACT}
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.11.3" "" )
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5DBus_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})
