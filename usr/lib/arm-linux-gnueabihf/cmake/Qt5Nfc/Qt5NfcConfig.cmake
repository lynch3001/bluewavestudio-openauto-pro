...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Nfc" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Nfc_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Nfc_VERSION_STRING 5.11.3)
...
macro(_populate_Nfc_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Nfc_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Nfc)
    ...
    set(_Qt5Nfc_OWN_INCLUDE_DIRS "${_qt5Nfc_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Nfc_install_prefix}/include/arm-linux-gnueabihf/qt5/QtNfc")
    set(Qt5Nfc_PRIVATE_INCLUDE_DIRS
        "${_qt5Nfc_install_prefix}/include/arm-linux-gnueabihf/qt5/QtNfc/5.11.3"
        "${_qt5Nfc_install_prefix}/include/arm-linux-gnueabihf/qt5/QtNfc/5.11.3/QtNfc"
    )
    ...
    foreach(_module_dep ${_Qt5Nfc_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Nfc_FIND_VERSION_EXACT}
    ...
    _populate_Nfc_target_properties(RELEASE "libQt5Nfc.so.5.11.3" "" )
    ...
    macro(_populate_Nfc_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Nfc_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Nfc_check_file_exists(${imported_location})
