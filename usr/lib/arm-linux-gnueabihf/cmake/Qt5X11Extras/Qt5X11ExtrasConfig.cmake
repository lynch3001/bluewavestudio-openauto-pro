...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5X11Extras" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5X11Extras_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5X11Extras_VERSION_STRING 5.11.3)
...
macro(_populate_X11Extras_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5X11Extras_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::X11Extras)
    ...
    set(_Qt5X11Extras_OWN_INCLUDE_DIRS "${_qt5X11Extras_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5X11Extras_install_prefix}/include/arm-linux-gnueabihf/qt5/QtX11Extras")
    ...
    foreach(_module_dep ${_Qt5X11Extras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5X11Extras_FIND_VERSION_EXACT}
    ...
    _populate_X11Extras_target_properties(RELEASE "libQt5X11Extras.so.5.11.3" "" )
    ...
    macro(_populate_X11Extras_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5X11Extras_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_X11Extras_check_file_exists(${imported_location})
