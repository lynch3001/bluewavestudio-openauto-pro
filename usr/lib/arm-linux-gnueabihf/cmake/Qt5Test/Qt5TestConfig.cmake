...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Test" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Test_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Test_VERSION_STRING 5.11.3)
...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Test_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Test)
    ...
    set(_Qt5Test_OWN_INCLUDE_DIRS "${_qt5Test_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Test_install_prefix}/include/arm-linux-gnueabihf/qt5/QtTest")
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/arm-linux-gnueabihf/qt5/QtTest/5.11.3"
        "${_qt5Test_install_prefix}/include/arm-linux-gnueabihf/qt5/QtTest/5.11.3/QtTest"
    )
    ...
    foreach(_module_dep ${_Qt5Test_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Test_FIND_VERSION_EXACT}
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.so.5.11.3" "" )
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Test_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})
