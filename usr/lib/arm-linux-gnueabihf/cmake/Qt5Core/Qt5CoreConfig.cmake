...
set(Qt5Core_VERSION_STRING 5.11.3)
...
macro(_populate_Core_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Core_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/arm-linux-gnueabihf/qt5/QtCore/5.11.3"
        "${_qt5Core_install_prefix}/include/arm-linux-gnueabihf/qt5/QtCore/5.11.3/QtCore"
    )
    ...
    foreach(_module_dep ${_Qt5Core_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Core_FIND_VERSION_EXACT}
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.11.3" "" )
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Core_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
