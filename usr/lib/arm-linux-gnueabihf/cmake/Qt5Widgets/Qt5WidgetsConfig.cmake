...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Widgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Widgets_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Widgets_VERSION_STRING 5.11.3)
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Widgets_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(_Qt5Widgets_OWN_INCLUDE_DIRS "${_qt5Widgets_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Widgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtWidgets")
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtWidgets/5.11.3"
        "${_qt5Widgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtWidgets/5.11.3/QtWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5Widgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Widgets_FIND_VERSION_EXACT}
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.11.3" "" )
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
