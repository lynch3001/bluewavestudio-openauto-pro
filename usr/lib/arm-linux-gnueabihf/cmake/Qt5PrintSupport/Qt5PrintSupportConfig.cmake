...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5PrintSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5PrintSupport_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5PrintSupport_VERSION_STRING 5.11.3)
...
macro(_populate_PrintSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5PrintSupport_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::PrintSupport)
    ...
    set(Qt5PrintSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5PrintSupport_install_prefix}/include/arm-linux-gnueabihf/qt5/QtPrintSupport/5.11.3"
        "${_qt5PrintSupport_install_prefix}/include/arm-linux-gnueabihf/qt5/QtPrintSupport/5.11.3/QtPrintSupport"
    )
    ...
    foreach(_module_dep ${_Qt5PrintSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5PrintSupport_FIND_VERSION_EXACT}
    ...
    _populate_PrintSupport_target_properties(RELEASE "libQt5PrintSupport.so.5.11.3" "" )
    ...
    macro(_populate_PrintSupport_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5PrintSupport_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_PrintSupport_check_file_exists(${imported_location})
