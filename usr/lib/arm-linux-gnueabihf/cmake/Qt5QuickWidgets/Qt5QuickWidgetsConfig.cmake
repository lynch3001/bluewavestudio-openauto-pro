...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5QuickWidgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5QuickWidgets_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5QuickWidgets_VERSION_STRING 5.11.3)
...
macro(_populate_QuickWidgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5QuickWidgets_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::QuickWidgets)
    ...
    set(_Qt5QuickWidgets_OWN_INCLUDE_DIRS "${_qt5QuickWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5QuickWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQuickWidgets")
    set(Qt5QuickWidgets_PRIVATE_INCLUDE_DIRS
        "${_qt5QuickWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQuickWidgets/5.11.3"
        "${_qt5QuickWidgets_install_prefix}/include/arm-linux-gnueabihf/qt5/QtQuickWidgets/5.11.3/QtQuickWidgets"
    )
    ...
    foreach(_module_dep ${_Qt5QuickWidgets_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5QuickWidgets_FIND_VERSION_EXACT}
    ...
    _populate_QuickWidgets_target_properties(RELEASE "libQt5QuickWidgets.so.5.11.3" "" )
    ...
    macro(_populate_QuickWidgets_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5QuickWidgets_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_QuickWidgets_check_file_exists(${imported_location})
