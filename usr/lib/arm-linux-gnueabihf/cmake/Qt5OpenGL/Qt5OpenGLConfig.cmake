...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5OpenGL" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGL_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5OpenGL_VERSION_STRING 5.11.3)
...
macro(_populate_OpenGL_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5OpenGL_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGL)
    ...
    set(_Qt5OpenGL_OWN_INCLUDE_DIRS "${_qt5OpenGL_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5OpenGL_install_prefix}/include/arm-linux-gnueabihf/qt5/QtOpenGL")
    set(Qt5OpenGL_PRIVATE_INCLUDE_DIRS
        "${_qt5OpenGL_install_prefix}/include/arm-linux-gnueabihf/qt5/QtOpenGL/5.11.3"
        "${_qt5OpenGL_install_prefix}/include/arm-linux-gnueabihf/qt5/QtOpenGL/5.11.3/QtOpenGL"
    )
    ...
    foreach(_module_dep ${_Qt5OpenGL_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5OpenGL_FIND_VERSION_EXACT}
    ...
    _populate_OpenGL_target_properties(RELEASE "libQt5OpenGL.so.5.11.3" "" )
    ...
    macro(_populate_OpenGL_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGL_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGL_check_file_exists(${imported_location})
