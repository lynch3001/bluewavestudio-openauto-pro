...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5OpenGLExtensions" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGLExtensions_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5OpenGLExtensions_VERSION_STRING 5.11.3)
...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    set(_Qt5OpenGLExtensions_OWN_INCLUDE_DIRS "${_qt5OpenGLExtensions_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5OpenGLExtensions_install_prefix}/include/arm-linux-gnueabihf/qt5/QtOpenGLExtensions")
    ...
    foreach(_module_dep ${_Qt5OpenGLExtensions_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5OpenGLExtensions_FIND_VERSION_EXACT}
    ...
    macro(_populate_OpenGLExtensions_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGLExtensions_check_file_exists(${imported_location})
