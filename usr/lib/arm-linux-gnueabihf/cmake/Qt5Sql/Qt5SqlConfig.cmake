...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Sql" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Sql_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Sql_VERSION_STRING 5.11.3)
...
macro(_populate_Sql_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Sql_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Sql)
    ...
    set(_Qt5Sql_OWN_INCLUDE_DIRS "${_qt5Sql_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Sql_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSql")
    set(Qt5Sql_PRIVATE_INCLUDE_DIRS
        "${_qt5Sql_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSql/5.11.3"
        "${_qt5Sql_install_prefix}/include/arm-linux-gnueabihf/qt5/QtSql/5.11.3/QtSql"
    )
    ...
    foreach(_module_dep ${_Qt5Sql_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Sql_FIND_VERSION_EXACT}
    ...
    _populate_Sql_target_properties(RELEASE "libQt5Sql.so.5.11.3" "" )
    ...
    macro(_populate_Sql_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Sql_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Sql_check_file_exists(${imported_location})
