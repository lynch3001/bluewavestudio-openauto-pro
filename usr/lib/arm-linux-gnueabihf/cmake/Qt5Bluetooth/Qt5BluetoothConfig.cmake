...
get_filename_component(_realOrig "/usr/lib/arm-linux-gnueabihf/cmake/Qt5Bluetooth" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Bluetooth_install_prefix "/usr/lib/arm-linux-gnueabihf/../../" ABSOLUTE)
else()
...
set(Qt5Bluetooth_VERSION_STRING 5.11.3)
...
macro(_populate_Bluetooth_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set(imported_location "${_qt5Bluetooth_install_prefix}/lib/arm-linux-gnueabihf/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(_Qt5Bluetooth_OWN_INCLUDE_DIRS "${_qt5Bluetooth_install_prefix}/include/arm-linux-gnueabihf/qt5/" "${_qt5Bluetooth_install_prefix}/include/arm-linux-gnueabihf/qt5/QtBluetooth")
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/arm-linux-gnueabihf/qt5/QtBluetooth/5.11.3"
        "${_qt5Bluetooth_install_prefix}/include/arm-linux-gnueabihf/qt5/QtBluetooth/5.11.3/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.11.3 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.so.5.11.3" "" )
    ...
    macro(_populate_Bluetooth_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        set(imported_location "${_qt5Bluetooth_install_prefix}/lib/arm-linux-gnueabihf/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Bluetooth_check_file_exists(${imported_location})
