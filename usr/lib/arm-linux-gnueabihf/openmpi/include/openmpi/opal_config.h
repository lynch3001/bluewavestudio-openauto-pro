...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-I/usr/include -DNDEBUG -g -O2 -fdebug-prefix-map=/build/openmpi=. -fstack-protector-strong -Wformat -Werror=format-security -O3 -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2   ' FFLAGS='-g -O2 -fdebug-prefix-map=/build/openmpi=. -fstack-protector-strong' LDFLAGS='-Wl,-z,relro   ' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict --disable-f77 --disable-f90"
...
#define MPI_COUNT_MAX 0x7fffffffl
...
#define OMPI_TARBALL_VERSION "3.1.3"
...
#define OPAL_ASSEMBLY_ARCH OPAL_ARM
...
#define OPAL_BTL_USNIC_UNIT_TESTS 1
...
/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION 525056

/* The compiler $lower which OMPI was built with */
#define OPAL_BUILD_PLATFORM_COMPILER_VERSION_STR 8.3.0
...
#define OPAL_IDENT_STRING "3.1.3"
...
#define OPAL_PACKAGE_STRING "Debian OpenMPI"
...
#define OPAL_RELEASE_DATE "Oct 29, 2018"
...
#define OPAL_TARBALL_VERSION "3.1.3"
...
#define ORTE_RELEASE_DATE "Oct 29, 2018"
...
#define OSHMEM_TARBALL_VERSION "3.1.3"

/* Complete release number of Open SHMEM */
#define OSHMEM_VERSION "3"
...
#define PACKAGE_STRING "Open MPI 3.1.3"
...
#define WRAPPER_EXTRA_LDFLAGS "    -Wl,-rpath -Wl,@{libdir} "

/* Additional LIBS to pass through the wrapper compilers */
#define WRAPPER_EXTRA_LIBS "-lhwloc -ldl -levent -levent_pthreads -lutil -lm  -lrt -lz"

/* Whether the wrapper compilers add rpath flags by default */
#define WRAPPER_RPATH_SUPPORT "rpath"
