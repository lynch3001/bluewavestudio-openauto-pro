...
set (p8-platform_INCLUDE_DIRS /usr/include/p8-platform /usr/include)
...
if(WIN32)
  set (p8-platform_LIBRARY "/usr//usr/lib/arm-linux-gnueabihf/p8-platform.lib")
else(WIN32)
  set (p8-platform_LIBRARY "-L/usr//usr/lib/arm-linux-gnueabihf -lp8-platform")
endif(WIN32)
